...
export function AssertValidAlphabeticalListOfProducts(pojo:AlphabeticalListOfProductsPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Alphabetical list of product', 'Discontinued', pojo, 'string'); break;
...
export function AssertValidCategorySalesFor1997(pojo:CategorySalesFor1997Pojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'CategorySales': assertValidFieldType('Category Sales for 1997', 'CategorySales', pojo, 'string'); break;
            default:
...
export function AssertValidInvoices(pojo:InvoicesPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Salesperson': assertValidFieldType('Invoice', 'Salesperson', pojo, 'string'); break;
            ...
            case 'ExtendedPrice': assertValidFieldType('Invoice', 'ExtendedPrice', pojo, 'string'); break;
...
export function AssertValidOrderDetailsExtended(pojo:OrderDetailsExtendedPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'ExtendedPrice': assertValidFieldType('Order Details Extended', 'ExtendedPrice', pojo, 'string'); break;
            default:
...
export function AssertValidOrderSubtotals(pojo:OrderSubtotalsPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Subtotal': assertValidFieldType('Order Subtotal', 'Subtotal', pojo, 'string'); break;
            default:
...
export function AssertValidProductSalesFor1997(pojo:ProductSalesFor1997Pojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'ProductSales': assertValidFieldType('Product Sales for 1997', 'ProductSales', pojo, 'string'); break;
            default:
...
export function AssertValidProducts(pojo:ProductsPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Product', 'Discontinued', pojo, 'string'); break;
...
export function AssertValidProductsByCategory(pojo:ProductsByCategoryPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Products by Category', 'Discontinued', pojo, 'string'); break;
            default:
...
export interface RegionsPojo
{
    RegionID:RegionId;
    RegionDescription:string;
}

export interface RegionsInstance extends sequelize.Instance<RegionsPojo>, RegionsPojo { }

export interface RegionsModel extends sequelize.Model<RegionsInstance, RegionsPojo> { }

export function AssertValidRegions(pojo:RegionsPojo, allowUndefined?:boolean):void {
...
asserters['Region'] = AssertValidRegions;
...
export function AssertValidSalesTotalsByAmount(pojo:SalesTotalsByAmountPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            case 'SaleAmount': assertValidFieldType('Sales Totals by Amount', 'SaleAmount', pojo, 'string'); break;
...
export function AssertValidSalesByCategory(pojo:SalesByCategoryPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'ProductSales': assertValidFieldType('Sales by Category', 'ProductSales', pojo, 'string'); break;
            default:
...
export function AssertValidSummaryOfSalesByQuarter(pojo:SummaryOfSalesByQuarterPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Subtotal': assertValidFieldType('Summary of Sales by Quarter', 'Subtotal', pojo, 'string'); break;
            default:
...
export function AssertValidSummaryOfSalesByYear(pojo:SummaryOfSalesByYearPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Subtotal': assertValidFieldType('Summary of Sales by Year', 'Subtotal', pojo, 'string'); break;
            default:
...
export function AssertValidTerritories(pojo:TerritoriesPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'region': assertValidFieldType('Territory', 'region', pojo, 'RegionsPojo'); break;
            default:

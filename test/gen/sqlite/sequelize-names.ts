...
export class RegionsFields {
    RegionID:string = 'RegionID';
    RegionDescription:string = 'RegionDescription';
}
export var regionsFields:RegionsFields = new RegionsFields();
...
export class References {
    ...
    RegionID:types.Reference = { tableName: 'Regions', primaryKey: 'regionId', foreignKey: 'RegionID', as: undefined};
    ...
    CustomerID:types.Reference = { tableName: 'CustomerCustomerDemo', primaryKey: 'CustomerID', foreignKey: 'CustomerID', as: undefined};
    ShipName:types.Reference = { tableName: 'Invoices', primaryKey: 'ShipName', foreignKey: 'ShipName', as: undefined};
    OrderID:types.Reference = { tableName: 'Order Details', primaryKey: 'OrderID', foreignKey: 'OrderID', as: undefined};

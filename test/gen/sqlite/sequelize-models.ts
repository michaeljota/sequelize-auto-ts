...
export var RegionsModel:types.RegionsModel;
...
export function initialize(database:string, username:string, password:string, options:sequelize.Options):any
{
    ...
    AlphabeticalListOfProductsModel = <types.AlphabeticalListOfProductsModel> SEQUELIZE.define<types.AlphabeticalListOfProductsInstance, types.AlphabeticalListOfProductsPojo>('Alphabetical list of product', {
        ...
        'QuantityPerUnit': {type: Sequelize.STRING, allowNull: false},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false},
        'UnitsInStock': {type: Sequelize.INTEGER, allowNull: false},
        'UnitsOnOrder': {type: Sequelize.INTEGER, allowNull: false},
        'ReorderLevel': {type: Sequelize.INTEGER, allowNull: false},
        'Discontinued': {type: Sequelize.STRING, allowNull: false},
    ...
    CategorySalesFor1997Model = <types.CategorySalesFor1997Model> SEQUELIZE.define<types.CategorySalesFor1997Instance, types.CategorySalesFor1997Pojo>('Category Sales for 1997', {
        ...
        'CategorySales': {type: Sequelize.STRING, allowNull: false}
        },
        {
            classMethods: {
    ...
    CustomerDemographicsModel = <types.CustomerDemographicsModel> SEQUELIZE.define<types.CustomerDemographicsInstance, types.CustomerDemographicsPojo>('CustomerDemographic', {
        ...
        'CustomerDesc': {type: Sequelize.STRING, allowNull: false}
        },
        {
            classMethods: {
    ...
    CustomersModel = <types.CustomersModel> SEQUELIZE.define<types.CustomersInstance, types.CustomersPojo>('Customer', {
        ...
        'CompanyName': {type: Sequelize.STRING, allowNull: false},
        'ContactName': {type: Sequelize.STRING, allowNull: false},
        'ContactTitle': {type: Sequelize.STRING, allowNull: false},
    ...
    EmployeesModel = <types.EmployeesModel> SEQUELIZE.define<types.EmployeesInstance, types.EmployeesPojo>('Employee', {
        ...
        'TitleOfCourtesy': {type: Sequelize.STRING, allowNull: false},
        'BirthDate': {type: Sequelize.DATE, allowNull: false},
        'HireDate': {type: Sequelize.DATE, allowNull: false},
        'Address': {type: Sequelize.STRING, allowNull: false},
        'City': {type: Sequelize.STRING, allowNull: false},
        'Region': {type: Sequelize.STRING, allowNull: false},
        'PostalCode': {type: Sequelize.STRING, allowNull: false},
        'Country': {type: Sequelize.STRING, allowNull: false},
        'HomePhone': {type: Sequelize.STRING, allowNull: false},
        ...
        'ReportsTo': {type: Sequelize.INTEGER, allowNull: false},
    ...
    InvoicesModel = <types.InvoicesModel> SEQUELIZE.define<types.InvoicesInstance, types.InvoicesPojo>('Invoice', {
        ...
        'ShipAddress': {type: Sequelize.STRING, allowNull: false},
        'ShipCity': {type: Sequelize.STRING, allowNull: false},
        'ShipRegion': {type: Sequelize.STRING, allowNull: false},
        'ShipPostalCode': {type: Sequelize.STRING, allowNull: false},
        'ShipCountry': {type: Sequelize.STRING, allowNull: false},
        'CustomerID': {type: Sequelize.STRING, allowNull: false},
        ...
        'PostalCode': {type: Sequelize.STRING, allowNull: false},
        'Country': {type: Sequelize.STRING, allowNull: false},
        'Salesperson': {type: Sequelize.STRING, allowNull: false},
        'OrderID': {type: Sequelize.INTEGER, allowNull: false},
        'OrderDate': {type: Sequelize.DATE, allowNull: false},
        'RequiredDate': {type: Sequelize.DATE, allowNull: false},
        'ShippedDate': {type: Sequelize.DATE, allowNull: false},
        'ShipperName': {type: Sequelize.STRING, allowNull: false},
        'ProductID': {type: Sequelize.INTEGER, allowNull: false},
        'ProductName': {type: Sequelize.STRING, allowNull: false},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false},
        'Quantity': {type: Sequelize.INTEGER, allowNull: false},
        'Discount': {type: Sequelize.DECIMAL, allowNull: false},
        'ExtendedPrice': {type: Sequelize.STRING, allowNull: false},
        'Freight': {type: Sequelize.DECIMAL, allowNull: false}
        },
        {
            classMethods: {
    ...
    OrderDetailsModel = <types.OrderDetailsModel> SEQUELIZE.define<types.OrderDetailsInstance, types.OrderDetailsPojo>('Order Detail', {
        ...
        'ProductID': {type: Sequelize.INTEGER, allowNull: false},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: "0"},
    ...
    OrderSubtotalsModel = <types.OrderSubtotalsModel> SEQUELIZE.define<types.OrderSubtotalsInstance, types.OrderSubtotalsPojo>('Order Subtotal', {
        'OrderID': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'Subtotal': {type: Sequelize.STRING, allowNull: false}
        },
        {
            classMethods: {
    ...
    OrdersModel = <types.OrdersModel> SEQUELIZE.define<types.OrdersInstance, types.OrdersPojo>('Order', {
        ...
        'RequiredDate': {type: Sequelize.DATE, allowNull: false},
        'ShippedDate': {type: Sequelize.DATE, allowNull: false},
        'ShipVia': {type: Sequelize.INTEGER, allowNull: false},
        'Freight': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: "0"},
        'ShipName': {type: Sequelize.STRING, allowNull: false},
        'ShipAddress': {type: Sequelize.STRING, allowNull: false},
        'ShipCity': {type: Sequelize.STRING, allowNull: false},
        'ShipRegion': {type: Sequelize.STRING, allowNull: false},
        'ShipPostalCode': {type: Sequelize.STRING, allowNull: false},
    ...
    ProductSalesFor1997Model = <types.ProductSalesFor1997Model> SEQUELIZE.define<types.ProductSalesFor1997Instance, types.ProductSalesFor1997Pojo>('Product Sales for 1997', {
        'CategoryName': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'ProductName': {type: Sequelize.STRING, allowNull: false},
        'ProductSales': {type: Sequelize.STRING, allowNull: false}
        },
        {
            classMethods: {
    ...
    ProductsModel = <types.ProductsModel> SEQUELIZE.define<types.ProductsInstance, types.ProductsPojo>('Product', {
        ...
        'QuantityPerUnit': {type: Sequelize.STRING, allowNull: false},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: "0"},
        'UnitsInStock': {type: Sequelize.INTEGER, allowNull: false, defaultValue: "0"},
        'UnitsOnOrder': {type: Sequelize.INTEGER, allowNull: false, defaultValue: "0"},
        'ReorderLevel': {type: Sequelize.INTEGER, allowNull: false, defaultValue: "0"},
        'Discontinued': {type: Sequelize.STRING, allowNull: false, defaultValue: "'0'"}
        },
        {
            classMethods: {
    ...
    RegionsModel = <types.RegionsModel> SEQUELIZE.define<types.RegionsInstance, types.RegionsPojo>('Region', {
        ...
        },
        {
            classMethods: {
                GetRegions:(region:any) => {
                    ...
                    return RegionsModel.find({where: where});
                }
            }
        });
    ...
    SuppliersModel = <types.SuppliersModel> SEQUELIZE.define<types.SuppliersInstance, types.SuppliersPojo>('Supplier', {
        ...
        'Phone': {type: Sequelize.STRING, allowNull: false},
        'Fax': {type: Sequelize.STRING, allowNull: false},
        'HomePage': {type: Sequelize.STRING, allowNull: false}
        },
        {
            classMethods: {
    ...
    EmployeesModel.hasMany(EmployeesModel, {foreignKey: 'EmployeeID' });
    EmployeesModel.belongsTo(EmployeesModel, {as: undefined, foreignKey: 'EmployeeID' });
    ...
    RegionsModel.hasMany(TerritoriesModel, {foreignKey: 'RegionID' });
    TerritoriesModel.belongsTo(RegionsModel, {as: undefined, foreignKey: 'RegionID' });

...
export function initialize(database:string, username:string, password:string, options:sequelize.Options):any
{
    ...
    EmployeesModel = <types.EmployeesModel> SEQUELIZE.define<types.EmployeesInstance, types.EmployeesPojo>('Employee', {
        ...
        'LastName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'FirstName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Title': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'TitleOfCourtesy': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'BirthDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'HireDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'Address': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'City': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Region': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'PostalCode': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Country': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'HomePhone': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Extension': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Photo': {type: Sequelize.BLOB, allowNull: false, defaultValue: undefined},
        'Notes': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ReportsTo': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'PhotoPath': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Salary': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CategoriesModel = <types.CategoriesModel> SEQUELIZE.define<types.CategoriesInstance, types.CategoriesPojo>('Category', {
        ...
        'CategoryName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Description': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Picture': {type: Sequelize.BLOB, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CustomersModel = <types.CustomersModel> SEQUELIZE.define<types.CustomersInstance, types.CustomersPojo>('Customer', {
        ...
        'CompanyName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ContactName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ContactTitle': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Address': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'City': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Region': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'PostalCode': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Country': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Phone': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Fax': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    SuppliersModel = <types.SuppliersModel> SEQUELIZE.define<types.SuppliersInstance, types.SuppliersPojo>('Supplier', {
        ...
        'Phone': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Fax': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'HomePage': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    OrdersModel = <types.OrdersModel> SEQUELIZE.define<types.OrdersInstance, types.OrdersPojo>('Order', {
        ...
        'CustomerID': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'EmployeeID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'OrderDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'RequiredDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'ShippedDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'ShipVia': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'Freight': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'ShipName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ShipAddress': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ShipCity': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ShipRegion': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ShipPostalCode': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ShipCountry': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
                GetOrders:(order:any) => {
    ...
    ProductsModel = <types.ProductsModel> SEQUELIZE.define<types.ProductsInstance, types.ProductsPojo>('Product', {
        ...
        'ProductName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'SupplierID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'CategoryID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'QuantityPerUnit': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'UnitsInStock': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'UnitsOnOrder': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'ReorderLevel': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'Discontinued': {type: Sequelize.BOOLEAN, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    OrderDetailsModel = <types.OrderDetailsModel> SEQUELIZE.define<types.OrderDetailsInstance, types.OrderDetailsPojo>('Order Detail', {
        'OrderID': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'ProductID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'Quantity': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'Discount': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CustomerAndSuppliersByCityModel = <types.CustomerAndSuppliersByCityModel> SEQUELIZE.define<types.CustomerAndSuppliersByCityInstance, types.CustomerAndSuppliersByCityPojo>('Customer and Suppliers by City', {
        ...
        'CompanyName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ContactName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Relationship': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    InvoicesModel = <types.InvoicesModel> SEQUELIZE.define<types.InvoicesInstance, types.InvoicesPojo>('Invoice', {
        ...
        'ShipCountry': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'CustomerID': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'CustomerName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Address': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'City': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Region': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'PostalCode': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Country': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'Salesperson': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'OrderID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'OrderDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'RequiredDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'ShippedDate': {type: Sequelize.DATE, allowNull: false, defaultValue: undefined},
        'ShipperName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ProductID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'ProductName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'UnitPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'Quantity': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined},
        'Discount': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'ExtendedPrice': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined},
        'Freight': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    OrderSubtotalsModel = <types.OrderSubtotalsModel> SEQUELIZE.define<types.OrderSubtotalsInstance, types.OrderSubtotalsPojo>('Order Subtotal', {
        'OrderID': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'Subtotal': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    ProductSalesFor1997Model = <types.ProductSalesFor1997Model> SEQUELIZE.define<types.ProductSalesFor1997Instance, types.ProductSalesFor1997Pojo>('Product Sales for 1997', {
        'CategoryName': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'ProductName': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'ProductSales': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CategorySalesFor1997Model = <types.CategorySalesFor1997Model> SEQUELIZE.define<types.CategorySalesFor1997Instance, types.CategorySalesFor1997Pojo>('Category Sales for 1997', {
        'CategoryName': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'CategorySales': {type: Sequelize.DECIMAL, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CustomerCustomerDemoModel = <types.CustomerCustomerDemoModel> SEQUELIZE.define<types.CustomerCustomerDemoInstance, types.CustomerCustomerDemoPojo>('CustomerCustomerDemo', {
        'CustomerID': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'CustomerTypeID': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CustomerDemographicsModel = <types.CustomerDemographicsModel> SEQUELIZE.define<types.CustomerDemographicsInstance, types.CustomerDemographicsPojo>('CustomerDemographic', {
        ...
        'CustomerDesc': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    RegionModel = <types.RegionModel> SEQUELIZE.define<types.RegionInstance, types.RegionPojo>('Region', {
        ...
        'RegionDescription': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    TerritoriesModel = <types.TerritoriesModel> SEQUELIZE.define<types.TerritoriesInstance, types.TerritoriesPojo>('Territory', {
        ...
        'TerritoryDescription': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined},
        'RegionID': {type: Sequelize.INTEGER, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    EmployeeTerritoriesModel = <types.EmployeeTerritoriesModel> SEQUELIZE.define<types.EmployeeTerritoriesInstance, types.EmployeeTerritoriesPojo>('EmployeeTerritory', {
        'EmployeeID': {type: Sequelize.INTEGER, primaryKey: true, autoIncrement: true},
        'TerritoryID': {type: Sequelize.STRING, allowNull: false, defaultValue: undefined}
        },
        {
            classMethods: {
    ...
    CustomerCustomerDemoModel.hasMany(CustomerCustomerDemoModel, {foreignKey: 'CustomerTypeID' });
    CustomerCustomerDemoModel.belongsTo(CustomerCustomerDemoModel, {as: undefined, foreignKey: 'CustomerTypeID' });

    
    CustomerCustomerDemoModel.hasMany(CustomerCustomerDemoModel, {foreignKey: 'CustomerID' });
    CustomerCustomerDemoModel.belongsTo(CustomerCustomerDemoModel, {as: undefined, foreignKey: 'CustomerID' });
    ...
    EmployeeTerritoriesModel.hasMany(EmployeeTerritoriesModel, {foreignKey: 'EmployeeID' });
    EmployeeTerritoriesModel.belongsTo(EmployeeTerritoriesModel, {as: undefined, foreignKey: 'EmployeeID' });

    
    EmployeeTerritoriesModel.hasMany(EmployeeTerritoriesModel, {foreignKey: 'TerritoryID' });
    EmployeeTerritoriesModel.belongsTo(EmployeeTerritoriesModel, {as: undefined, foreignKey: 'TerritoryID' });

    
    OrderDetailsModel.hasMany(OrderDetailsModel, {foreignKey: 'OrderID' });
    OrderDetailsModel.belongsTo(OrderDetailsModel, {as: undefined, foreignKey: 'OrderID' });

    
    OrderDetailsModel.hasMany(OrderDetailsModel, {foreignKey: 'ProductID' });
    OrderDetailsModel.belongsTo(OrderDetailsModel, {as: undefined, foreignKey: 'ProductID' });

    
    OrdersModel.hasMany(OrdersModel, {foreignKey: 'CustomerID' });
    OrdersModel.belongsTo(OrdersModel, {as: undefined, foreignKey: 'CustomerID' });

    
    OrdersModel.hasMany(OrdersModel, {foreignKey: 'EmployeeID' });
    OrdersModel.belongsTo(OrdersModel, {as: undefined, foreignKey: 'EmployeeID' });

    
    OrdersModel.hasMany(OrdersModel, {foreignKey: 'ShipVia' });
    OrdersModel.belongsTo(OrdersModel, {as: undefined, foreignKey: 'ShipVia' });

    
    ProductsModel.hasMany(ProductsModel, {foreignKey: 'CategoryID' });
    ProductsModel.belongsTo(ProductsModel, {as: undefined, foreignKey: 'CategoryID' });

    
    ProductsModel.hasMany(ProductsModel, {foreignKey: 'SupplierID' });
    ProductsModel.belongsTo(ProductsModel, {as: undefined, foreignKey: 'SupplierID' });

    
    TerritoriesModel.hasMany(TerritoriesModel, {foreignKey: 'RegionID' });
    TerritoriesModel.belongsTo(TerritoriesModel, {as: undefined, foreignKey: 'RegionID' });

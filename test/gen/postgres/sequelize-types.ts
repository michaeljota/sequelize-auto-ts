...
export function AssertValidAlphabeticalListOfProducts(pojo:AlphabeticalListOfProductsPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Alphabetical list of product', 'Discontinued', pojo, 'number'); break;
...
export function AssertValidProducts(pojo:ProductsPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Product', 'Discontinued', pojo, 'number'); break;
...
export function AssertValidProductsByCategory(pojo:ProductsByCategoryPojo, allowUndefined?:boolean):void {
    ...
    while(i-- > 0) {
        switch(fieldNames[i]) {
            ...
            case 'Discontinued': assertValidFieldType('Products by Category', 'Discontinued', pojo, 'number'); break;
            default:

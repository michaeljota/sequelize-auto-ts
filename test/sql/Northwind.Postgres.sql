...
ALTER TABLE "Alphabetical list of products" OWNER TO postgres;

--
-- Name: Order Details; Type: TABLE; Schema: public; Owner: postgres; Tablespace:
--
...
ALTER TABLE "Order Details" OWNER TO postgres;
...
CREATE VIEW "Product Sales for 1997" AS
 SELECT "Categories"."CategoryName",
    "Products"."ProductName",
    sum((((("Order Details"."UnitPrice" * ("Order Details"."Quantity")::double precision) * ((1)::double precision - "Order Details"."Discount")) / (100)::double precision) * (100)::double precision)) AS "ProductSales"
   FROM ((("Categories"
     JOIN "Products" ON (("Categories"."CategoryID" = "Products"."CategoryID")))
...
ALTER TABLE "Product Sales for 1997" OWNER TO postgres;
...
ALTER TABLE "Category Sales for 1997" OWNER TO postgres;
...
ALTER TABLE "Current Product List" OWNER TO postgres;
...
ALTER TABLE "Customer and Suppliers by City" OWNER TO postgres;
...
CREATE VIEW "Invoices" AS
 SELECT "Orders"."ShipName",
    ...
    "Customers"."Country",
    ((("Employees"."FirstName")::text || ' '::text) || ("Employees"."LastName")::text) AS "Salesperson",
    "Orders"."OrderID",
    "Orders"."OrderDate",
    "Orders"."RequiredDate",
    "Orders"."ShippedDate",
    ...
    (((("Order Details"."UnitPrice" * ("Order Details"."Quantity")::double precision) * ((1)::double precision - "Order Details"."Discount")) / (100)::double precision) * (100)::double precision) AS "ExtendedPrice",
    "Orders"."Freight"
   FROM ((((("Customers"
...
ALTER TABLE "Order Details Extended" OWNER TO postgres;
...
CREATE VIEW "Order Subtotals" AS
 SELECT "Order Details"."OrderID",
    sum((((("Order Details"."UnitPrice" * ("Order Details"."Quantity")::double precision) * ((1)::double precision - "Order Details"."Discount")) / (100)::double precision) * (100)::double precision)) AS "Subtotal"
   FROM "Order Details"
  GROUP BY "Order Details"."OrderID";


ALTER TABLE "Order Subtotals" OWNER TO postgres;
...
ALTER TABLE "Orders Qry" OWNER TO postgres;
...
ALTER TABLE "Products Above Average Price" OWNER TO postgres;
...
ALTER TABLE "Products by Category" OWNER TO postgres;
...
ALTER TABLE "Quarterly Orders" OWNER TO postgres;
...
CREATE VIEW "Sales Totals by Amount" AS
 SELECT "Order Subtotals"."Subtotal" AS "SaleAmount",
  ...
  WHERE (("Order Subtotals"."Subtotal" > (2500)::double precision) AND (("Orders"."ShippedDate" >= '1997-01-01'::date) AND ("Orders"."ShippedDate" <= '1997-12-31'::date)));


ALTER TABLE "Sales Totals by Amount" OWNER TO postgres;
...
ALTER TABLE "Sales by Category" OWNER TO postgres;
...
ALTER TABLE "Summary of Sales by Quarter" OWNER TO postgres;
...
ALTER TABLE "Summary of Sales by Year" OWNER TO postgres;
...
COPY "Categories" ("CategoryID", "CategoryName", "Description", "Picture") FROM stdin;
...
COPY "CustomerCustomerDemo" ("CustomerID", "CustomerTypeID") FROM stdin;
\.
...
COPY "CustomerDemographics" ("CustomerTypeID", "CustomerDesc") FROM stdin;
\.
...
COPY "EmployeeTerritories" ("EmployeeID", "TerritoryID") FROM stdin;
1	06897
1	19713
2	01581
2	01730
...
COPY "Employees" ("EmployeeID", "LastName", "FirstName", "Title", "TitleOfCourtesy", "BirthDate", "HireDate", "Address", "City", "Region", "PostalCode", "Country", "HomePhone", "Extension", "Photo", "Notes", "ReportsTo", "PhotoPath") FROM stdin;
...
COPY "Order Details" ("OrderID", "ProductID", "UnitPrice", "Quantity", "Discount") FROM stdin;
10248	11	14	12	0
...
COPY "Region" ("RegionID", "RegionDescription") FROM stdin;
1	Eastern
2	Western
3	Northern
4	Southern
...
COPY "Territories" ("TerritoryID", "TerritoryDescription", "RegionID") FROM stdin;
01581	Westboro	1
01730	Bedford	1
01833	Georgetow	1
02116	Boston	1
...
--
-- Name: PK_Order Details; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace:
--
...
--
-- Name: CategoryName; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "CategoryName" ON "Categories" USING btree ("CategoryName");


--
-- Name: City; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "City" ON "Customers" USING btree ("City");


--
-- Name: CompanyName; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "CompanyName" ON "Customers" USING btree ("CompanyName");


--
-- Name: IDX_Region; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "IDX_Region" ON "Customers" USING btree ("Region");


--
-- Name: LastName; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "LastName" ON "Employees" USING btree ("LastName");


--
-- Name: OrderDate; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "OrderDate" ON "Orders" USING btree ("OrderDate");


--
-- Name: PostalCode; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "PostalCode" ON "Employees" USING btree ("PostalCode");


--
-- Name: ProductName; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "ProductName" ON "Products" USING btree ("ProductName");


--
-- Name: ShipPostalCode; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "ShipPostalCode" ON "Orders" USING btree ("ShipPostalCode");


--
-- Name: ShippedDate; Type: INDEX; Schema: public; Owner: postgres; Tablespace:
--

CREATE INDEX "ShippedDate" ON "Orders" USING btree ("ShippedDate");


--
-- Name: FK_CustomerCustomerDemo; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

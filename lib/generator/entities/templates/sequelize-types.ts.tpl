...
import entities = require('./sequelize-entities');
...
export interface __pojoName__ extends entities.__entityName__
{
    /*__each__ refs */ __fieldNameAndIsNullable__:__customFieldType__;
}

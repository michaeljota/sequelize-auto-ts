...
var TypeMapper = (function () {
    ...
    TypeMapper.init = function (dialect) {
        ...
        TypeMapper.fieldTypeTranslations.concat(TypeMapper.fieldTypeTranslationsInternal);
        TypeMapper.fieldTypeSequelize = {};
        TypeMapper.fieldTypeSequelize.concat(TypeMapper.fieldTypeSequelizeInternal);
        switch (dialect) {
            case 'mssql':
